...
$query = "CREATE TABLE IF NOT EXISTS `pn_users` (id int(8) PRIMARY KEY AUTO_INCREMENT, `name` varchar(32), `login` varchar(32), `hash` char(32), `salt` char(32), `group` tinyint(1))";
